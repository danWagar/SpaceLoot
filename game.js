...
export default class Game {
    ...
    for (let i = 0; i < numEnemies; i++) {
      switch (spawnPoint) {
        case 0:
          this.enemyArr.push(
            new Enemy(
              0 - Math.floor(Math.random() * (canv.width / 4 - width)),
              Math.floor(Math.random() * (canv.height / 4 - height)),
              width,
              height
            )
          );
        ...
        case 1:
          this.enemyArr.push(
            new Enemy(
              canv.width + Math.floor(Math.random() * (canv.width / 4 - width)),
              Math.floor(Math.random() * (canv.height / 4 - height)),
              width,
              height
            )
        ...
        case 2:
          this.enemyArr.push(
            new Enemy(
              Math.floor(Math.random() * (canv.width / 4 - width)),
              canv.height + Math.floor(Math.random() * (canv.height / 4 - height)),
              width,
              height
            )
          );
  ...
  getCoins(numCoins, canv) {
    ...
    for (let i = 0; i < numCoins; i++) {
      this.coinArr.push(
        new Coin(
          Math.floor(Math.random() * (canv.width - width)),
          Math.floor(Math.random() * (canv.height - height)),
          width,
          height
        )
      );
  ...
  fireBullet() {
    ...
    this.bulletArr.unshift(
      new Bullet(playerCenterX, playerCenterY, bulletWidth, bulletHeight, this._player.angle, this.bulletImg)
    );
